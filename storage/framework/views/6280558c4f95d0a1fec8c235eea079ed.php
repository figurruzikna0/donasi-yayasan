<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-theme="baitul">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <title><?php echo e($profil?->nama_yayasan ?? 'Yayasan Baitul Yatim Sukabumi'); ?></title>
...
<?php endif; ?>
                    ...
                    <?php if(session('warning')): ?>
                        <?php if (isset($component)) { $__componentOriginal5194778a3a7b899dcee5619d0610f5cf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert','data' => ['type' => 'warning','message' => ''.e(session('warning')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','message' => ''.e(session('warning')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5194778a3a7b899dcee5619d0610f5cf)): ?>
<?php $attributes = $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf; ?>
...
<?php endif; ?>
                    ...
                    <?php if(session('status')): ?>
                        <?php if (isset($component)) { $__componentOriginal5194778a3a7b899dcee5619d0610f5cf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert','data' => ['type' => 'success','message' => ''.e(session('status')).'','title' => 'Informasi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'success','message' => ''.e(session('status')).'','title' => 'Informasi']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5194778a3a7b899dcee5619d0610f5cf)): ?>
<?php $attributes = $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf; ?>
...
<?php endif; ?>
        ...
        <aside id="admin-sidebar"
            ...
            <div class="px-8 py-9 border-b border-white/10">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3">
                    <?php if($profil && $profil->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $profil->logo) . '?v=' . now()->timestamp); ?>" alt="Logo" class="h-9 w-9 rounded-lg object-cover ring-2 ring-white/30">
                    <?php else: ?>
            ...
            <div class="px-4 pt-6 pb-1">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white transition-all duration-150 relative mb-0.5 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-white/13 before:absolute before:left-0 before:top-[22%] before:bottom-[22%] before:w-[3px] before:bg-brand-300 before:rounded-r-sm' : 'text-white/62 hover:bg-white/10 hover:text-white'); ?>">
            ...
            <div class="px-4 pt-5 pb-1">
                ...
                <a href="<?php echo e(route('admin.profil.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                ...
                <a href="<?php echo e(route('admin.news.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                ...
                <a href="<?php echo e(route('admin.campaigns.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
            ...
            <div class="px-4 pt-5 pb-1">
                ...
                <a href="<?php echo e(route('admin.foster-children.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                    <svg class="w-4 h-4 shrink-0 opacity-65" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    Data Anak Asuh
                </a>
                <a href="<?php echo e(route('admin.sponsorships.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                    <svg class="w-4 h-4 shrink-0 opacity-65" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    Orang Tua Asuh
                </a>
                <a href="<?php echo e(route('admin.child-developments.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                ...
                <a href="<?php echo e(route('admin.transactions.index')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                    ...
                    <?php if($pendingCount > 0): ?>
                        <span class="ml-auto bg-brand-300 text-brand-800 text-[0.6rem] font-extrabold px-1.5 py-0.5 rounded-full"><?php echo e($pendingCount); ?></span>
                    <?php endif; ?>
                </a>
            </div>
            ...
            <div class="px-4 pt-5 pb-1">
                ...
                <a href="<?php echo e(route('admin.rekap.donasi')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                    <svg class="w-4 h-4 shrink-0 opacity-65" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                    Data Donasi
                </a>
                <a href="<?php echo e(route('admin.rekap.donatur')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                    <svg class="w-4 h-4 shrink-0 opacity-65" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    Data Donatur
                </a>
                <a href="<?php echo e(route('admin.rekap.orang-tua-asuh')); ?>" onclick="closeSidebar()" class="flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs font-semibold text-white/62 hover:bg-white/10 hover:text-white transition-all duration-150 relative mb-0.5">
                    <svg class="w-4 h-4 shrink-0 opacity-65" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    Data Orang Tua Asuh
                </a>
            </div>
                ...
                <div class="px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <?php if($profil && $profil->logo): ?>
                                <img src="<?php echo e(asset('storage/' . $profil->logo) . '?v=' . now()->timestamp); ?>" alt="Logo" class="h-8 w-8 rounded-lg object-cover ring-2 ring-base-200 lg:hidden">
                            <?php endif; ?>
                        ...
                        <div class="dropdown dropdown-end">
                            <button tabindex="0" class="flex items-center gap-2.5 px-3 py-2 rounded-lg hover:bg-base-200 transition-colors">
                                <?php if($adminUser->avatar): ?>
                                    <img src="<?php echo e(asset('storage/' . $adminUser->avatar)); ?>" class="w-8 h-8 rounded-full object-cover ring-2 ring-base-300">
                                <?php else: ?>
                                    <div class="w-8 h-8 rounded-full bg-primary/10 text-primary font-extrabold text-sm flex items-center justify-center ring-2 ring-base-300">
                                        <?php echo e(strtoupper(substr($adminUser->name, 0, 1))); ?>

                                    </div>
                                <?php endif; ?>
                                <span class="text-sm font-bold text-base-content hidden sm:inline"><?php echo e($adminUser->name); ?></span>
                            ...
                            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-56 p-2 shadow-lg border border-base-200">
                                ...
                                <li><a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2">
                                ...
                                <li>
                                    <form method="POST" action="<?php echo e(route('logout')); ?>" class="p-0">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\donasi-yayasan\resources\views/layouts/admin.blade.php ENDPATH**/ ?>