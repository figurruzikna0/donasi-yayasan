...
<head>
    ...
    <title><?php echo e($profil?->nama_yayasan ?? 'Baitul Yatim'); ?> - Salurkan Kebaikan Anda</title>
...
<body class="font-sans antialiased">
    ...
    <header class="relative hero min-h-[65vh] lg:min-h-[75vh] overflow-hidden">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo e(asset('images/hero-bg.jpg')); ?>'); background-size: cover;">
    ...
    <section id="tentang-kami" class="relative py-20 lg:py-28 px-4 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto relative">
            <div data-aos="fade-up" class="text-center max-w-3xl mx-auto mb-14">
                ...
                <h2 class="text-3xl md:text-4xl font-black text-emerald-900 tracking-tight">Tentang <?php echo e($profil?->nama_yayasan ?? 'Baitul Yatim'); ?></h2>
                ...
                <div class="lg:col-span-3 flex flex-col gap-6">
                    ...
                    <div data-aos="fade-up" class="relative bg-white rounded-2xl shadow-md border border-emerald-100 p-8 hover:shadow-lg transition-shadow">
                        ...
                        <div class="border-l-2 border-emerald-100 pl-5">
                            <p class="text-gray-600 leading-relaxed whitespace-pre-line">
                                <?php echo e($profil?->sejarah_yayasan ?? 'Informasi sejarah belum diisi oleh administrator backend.'); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div data-aos="fade-up" data-aos-delay="100" class="relative bg-white rounded-2xl shadow-md border border-emerald-100 p-6 hover:shadow-lg transition-shadow group">
                            ...
                            <p class="text-sm text-gray-600 leading-relaxed"><?php echo e($profil?->visi ?? 'Menjadi lembaga pengasuhan anak yatim dan sosial yang amanah, transparan, serta profesional.'); ?></p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-700 mt-0.5 leading-relaxed"><?php echo e($profil?->alamat ?? 'Alamat belum diatur'); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-700 mt-0.5 font-semibold"><?php echo e($profil?->no_telp ?? '-'); ?></p>
                                </div>
                            </div>
                            <div class="border-t border-emerald-50"></div>
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-700 mt-0.5"><?php echo e($profil?->email ?? '-'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <?php $daftarPendiri = \App\Models\Pendiri::latest()->get(); ?>
    <section id="pendiri" class="py-20 lg:py-28 px-4 bg-white">
        <div class="max-w-7xl mx-auto">
            ...
            <?php if($daftarPendiri->isNotEmpty()): ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 justify-center">
                    <?php $__currentLoopData = $daftarPendiri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>" class="card bg-base-100 shadow-md border border-emerald-100 rounded-2xl p-6 text-center flex flex-col items-center hover:shadow-lg transition-shadow">
                            <div class="avatar">
                                <div class="w-20 rounded-full ring ring-emerald-100 ring-offset-2 mb-4">
                                    <?php if($person->foto): ?>
                                        <img src="<?php echo e(asset('storage/' . $person->foto)); ?>" alt="<?php echo e($person->nama); ?>">
                                    <?php else: ?>
                                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($person->nama)); ?>&background=b3e093&color=5c8148&bold=true" alt="">
                                    <?php endif; ?>
                                </div>
                            </div>
                            <h3 class="text-base font-bold text-emerald-900"><?php echo e($person->nama); ?></h3>
                            <span class="badge badge-success badge-sm mt-1 mb-3"><?php echo e($person->jabatan); ?></span>
                            <?php if($person->deskripsi): ?>
                                <p class="text-xs text-gray-500 italic leading-relaxed border-t border-emerald-50 pt-3">"<?php echo e($person->deskripsi); ?>"</p>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div data-aos="fade-right" class="card bg-base-100 shadow-md border border-emerald-100 rounded-2xl p-6">
                    ...
                    <?php if($profil): ?>
                        <?php if($profil->legalitas): ?><p class="text-sm text-gray-600 mb-4"><?php echo e($profil->legalitas); ?></p><?php endif; ?>
                        <?php if($profil->foto_legalitas): ?>
                            <a href="<?php echo e(asset('storage/' . $profil->foto_legalitas)); ?>" target="_blank">
                                <img src="<?php echo e(asset('storage/' . $profil->foto_legalitas)); ?>" class="w-full h-auto max-h-[350px] object-contain rounded-lg border border-emerald-100 shadow-sm" alt="Dokumen Legalitas">
                            </a>
                        <?php else: ?>
                ...
                <div data-aos="fade-left" class="card bg-base-100 shadow-md border border-emerald-100 rounded-2xl p-6">
                    ...
                    <?php if($profil?->foto_struktur): ?>
                        <a href="<?php echo e(asset('storage/' . $profil->foto_struktur)); ?>" target="_blank">
                            <img src="<?php echo e(asset('storage/' . $profil->foto_struktur)); ?>" class="w-full h-auto max-h-[350px] object-contain rounded-lg border border-emerald-100 shadow-sm" alt="Struktur Organisasi">
                        </a>
                    <?php else: ?>
            ...
            <?php if($campaigns->isNotEmpty()): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 80); ?>" class="card bg-base-100 shadow-md border border-emerald-100 rounded-2xl overflow-hidden flex flex-col hover:shadow-lg transition-shadow">
                            ...
                            <div class="card-body p-5 flex flex-col flex-1">
                                <h3 class="font-bold text-base text-emerald-900 mb-2 line-clamp-2"><?php echo e($campaign->title); ?></h3>
                                <p class="text-xs text-gray-500 leading-relaxed line-clamp-2 mb-4 flex-1"><?php echo e($campaign->description); ?></p>
                                <?php $pct = $campaign->target_amount > 0 ? min(($campaign->collected_amount / $campaign->target_amount) * 100, 100) : 0; ?>
                                <div class="mb-3">
                                    <div class="flex justify-between text-xs text-emerald-600 mb-1">
                                        <span class="font-semibold"><?php echo e(number_format($pct, 1)); ?>%</span>
                                        <span class="font-semibold">Rp <?php echo e(number_format($campaign->collected_amount, 0, ',', '.')); ?> / Rp <?php echo e(number_format($campaign->target_amount, 0, ',', '.')); ?></span>
                                    </div>
                                    <progress class="progress progress-success w-full h-2" value="<?php echo e($pct); ?>" max="100"></progress>
                                </div>
                                <a href="<?php echo e(route('donations.create', $campaign->id)); ?>" class="btn btn-success text-white font-bold w-full mt-1">Donasi Sekarang</a>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="max-w-3xl mx-auto text-center" data-aos="fade-up">
            ...
            <div class="mt-8 bg-white/70 border border-emerald-200 rounded-2xl p-8 shadow-sm max-w-lg mx-auto">
                ...
                <div class="mt-6 flex flex-wrap justify-center gap-3">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-success text-white font-bold px-6">Daftar Sekarang</a>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline btn-success font-bold px-6">Masuk</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div data-aos="fade-up" class="news-carousel-outer relative px-6">
                ...
                <div class="overflow-hidden">
                    <div class="flex gap-6 transition-transform duration-[450ms] ease-[cubic-bezier(0.4,0,0.2,1)] will-change-transform" id="news-track">
                        <?php $__currentLoopData = $newsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="news-slide flex-none w-full sm:w-1/2 lg:w-1/3 min-w-0">
                            <a href="<?php echo e(route('news.show', $item->slug)); ?>" class="card bg-base-100 shadow-md border border-emerald-100 rounded-2xl overflow-hidden flex flex-col h-full hover:shadow-lg transition-all group">
                                <?php if($item->foto_utama): ?>
                                    <figure class="h-48 overflow-hidden">
                                        <img src="<?php echo e(asset('storage/' . $item->foto_utama)); ?>" alt="<?php echo e($item->judul); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                                    </figure>
                                <?php else: ?>
                                    <div class="h-48 bg-gradient-to-br from-emerald-100 to-emerald-50 flex items-center justify-center">
                                ...
                                <div class="p-5 flex flex-col flex-1">
                                    <span class="badge badge-success badge-sm mb-2"><?php echo e($item->kategori); ?></span>
                                    <h3 class="text-sm font-extrabold text-emerald-900 leading-snug mb-2 line-clamp-2 group-hover:text-emerald-600 transition-colors"><?php echo e($item->judul); ?></h3>
                                    <p class="text-xs text-gray-500 leading-relaxed flex-1 line-clamp-3 mb-4">
                                        <?php echo e($item->ringkasan ?: \Illuminate\Support\Str::limit(strip_tags($item->konten), 120)); ?>
                                    ...
                                    <div class="flex items-center justify-between text-[0.65rem] text-emerald-500 font-semibold border-t border-emerald-100 pt-3 mt-auto">
                                        <span>📅 <?php echo e($item->tanggal_kegiatan->translatedFormat('d M Y')); ?></span>
                                        <?php if($item->lokasi): ?><span>📍 <?php echo e(\Illuminate\Support\Str::limit($item->lokasi, 22)); ?></span><?php endif; ?>
                                    </div>
                                </div>
                            </a>
                        </div>
    ...
    <footer class="bg-emerald-900">
        <div class="max-w-7xl mx-auto px-4 py-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center gap-2.5 mb-3">
                        <?php if($profil && $profil->logo): ?>
                            <img src="<?php echo e(asset('storage/' . $profil->logo)); ?>" class="w-9 h-9 rounded-lg object-cover flex-shrink-0" alt="Logo">
                        <?php else: ?>
                            <span class="w-9 h-9 rounded-lg bg-emerald-800 flex items-center justify-center text-base flex-shrink-0">🌿</span>
                        <?php endif; ?>
                        <div>
                            <p class="text-sm font-bold text-emerald-100"><?php echo e($profil?->nama_yayasan ?? 'Baitul Yatim'); ?></p>
                            <p class="text-[11px] text-emerald-400">Lembaga Sosial Amanah</p>
                        </div>
                    </div>
                    <p class="text-xs text-emerald-400 leading-relaxed"><?php echo e($profil?->alamat ?? 'Alamat belum diatur'); ?></p>
                </div>
                <div>
                    <p class="text-xs text-emerald-300 font-semibold uppercase tracking-wider mb-3">Kontak</p>
                    <ul class="space-y-2">
                        <li><a href="tel:<?php echo e($profil?->no_telp); ?>" class="text-sm text-emerald-400 hover:text-emerald-200 transition-colors">📞 <?php echo e($profil?->no_telp ?? '-'); ?></a></li>
                        <li><a href="mailto:<?php echo e($profil?->email); ?>" class="text-sm text-emerald-400 hover:text-emerald-200 transition-colors">✉️ <?php echo e($profil?->email ?? '-'); ?></a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="mt-10 pt-5 border-t border-emerald-800 text-center">
                <p class="text-xs text-emerald-500">&copy; <?php echo e(date('Y')); ?> <?php echo e($profil?->nama_yayasan ?? 'Baitul Yatim'); ?>. Dikelola dengan penuh amanah & transparansi.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\laragon\www\donasi-yayasan\resources\views/welcome.blade.php ENDPATH**/ ?>