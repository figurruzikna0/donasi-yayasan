    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 pb-10 border-b border-brand-800/60">
            <div class="flex items-center gap-4">
                <div class="relative">
                    <?php if($profil && $profil->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $profil->logo) . '?v=' . now()->timestamp); ?>"
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(url('/#kampanye')); ?>"
                ...
                <a href="<?php echo e(url('/#program-ota')); ?>"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-12">
            ...
            <div>
                ...
                <ul class="space-y-3.5">
                    ...
                    <li>
                        <a href="<?php echo e(url('/#berita-kegiatan')); ?>"
                           class="group inline-flex items-center gap-2 text-sm text-brand-400 hover:text-brand-200 transition-all duration-200">
                    ...
                    <li>
                        <a href="<?php echo e(route('legalitas')); ?>"
                           class="group inline-flex items-center gap-2 text-sm text-brand-400 hover:text-brand-200 transition-all duration-200">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="tel:<?php echo e($profil?->no_telp); ?>" class="group flex items-center gap-3 text-sm text-brand-400 hover:text-brand-200 transition-all duration-200">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-brand-300 group-hover:text-brand-200 transition-colors"><?php echo e($profil?->no_telp ?? '0812-3456-7890'); ?></p>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="mailto:<?php echo e($profil?->email); ?>" class="group flex items-center gap-3 text-sm text-brand-400 hover:text-brand-200 transition-all duration-200">
                            <span class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 transition-all" style="background-color:rgba(45,125,98,0.15);color:#4a9a7b">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-brand-300 group-hover:text-brand-200 transition-colors"><?php echo e($profil?->email ?? 'info@baitulyatim.or.id'); ?></p>
                            </div>
                        </a>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-brand-400">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-brand-300 leading-relaxed"><?php echo e($profil?->alamat ?? 'Kp. Babakan Cimenteng Rt 37/07, Ds. Gunung Guruh, Kec. Gunung Guruh - Sukabumi'); ?></p>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-brand-800/60">
            <p class="text-xs text-brand-500 text-center sm:text-left">&copy; <?php echo e(date('Y')); ?> <?php echo e($profil?->nama_yayasan ?? 'Yayasan Baitul Yatim Sukabumi'); ?>. Dikelola dengan penuh amanah &amp; transparansi.</p>
