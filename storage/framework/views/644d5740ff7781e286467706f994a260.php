        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                ...
                <div class="bg-gradient-to-r from-emerald-700 via-emerald-500 to-emerald-400 p-4 flex items-center justify-between gap-3 flex-wrap">
                    ...
                    <a href="<?php echo e(route('admin.child-developments.create')); ?>" class="btn btn-success btn-sm">
                ...
                <div class="overflow-x-auto">
                    <table class="table table-zebra w-full">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $developments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <?php if($item->foto): ?>
                                            <img src="<?php echo e(asset('storage/' . $item->foto)); ?>" alt="<?php echo e($item->judul); ?>" class="w-14 h-14 object-cover rounded border border-emerald-200">
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge badge-ghost badge-sm mt-1"><?php echo e($item->fosterChild->name ?? '-'); ?></span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form action="<?php echo e(route('admin.child-developments.destroy', $item->id)); ?>" method="POST"
                                                ...
                                                <button type="button" @click="open = true" class="btn btn-sm btn-error">
                                                    ...
                                                    <dialog class="modal" :class="{ 'modal-open': open }">
                                                        <div class="modal-box"><h3 class="font-bold text-lg">Konfirmasi Hapus</h3><p class="py-4">Hapus laporan '<?php echo e($item->judul); ?>'?</p>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-16">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <a href="<?php echo e(route('admin.child-developments.create')); ?>" class="btn btn-success btn-sm mt-1">
                                                + Tambah Sekarang
                                            </a>
                                        </div>
                                    </td>
                ...
                <?php if($developments->hasPages()): ?>
                    <div class="p-4 border-t border-emerald-100">
                        <?php echo e($developments->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\donasi-yayasan\resources\views/admin/child-developments/index.blade.php ENDPATH**/ ?>