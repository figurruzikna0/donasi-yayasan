    ...
    <div class="bg-base-200 min-h-screen">
        ...
        <div class="px-8 pt-8 pb-0">
            <div class="flex items-end justify-between gap-3 mb-2 flex-wrap">
                ...
                <a href="<?php echo e(route('admin.child-developments.create')); ?>" class="btn bg-primary hover:bg-primary/90 text-white border-0 font-bold shadow-sm rounded-lg gap-2">
                                ...
                                <tr class="hover:bg-base-200/30 transition-colors">
                                        ...
                                        <?php if($item->foto): ?>
                                            <div class="avatar">
                                                <div class="w-12 h-12 rounded-lg ring ring-base-300 ring-offset-1">
                                                    <img src="<?php echo e(asset('storage/' . $item->foto)); ?>" alt="<?php echo e($item->judul); ?>" class="object-cover">
                                                </div>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-1">
                                            <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[0.6rem] font-bold bg-primary/5 text-primary border border-primary/20">
                                                ...
                                                <?php echo e($item->fosterChild->name ?? '-'); ?>
                                    ...
                                    <td>
                                        <div class="flex items-center justify-center gap-1">
                                            <a href="<?php echo e(route('admin.child-developments.show', $item->id)); ?>" class="btn btn-sm btn-ghost text-base-content/50 hover:text-primary hover:bg-primary/5 rounded-lg font-bold">
                                            ...
                                            <a href="<?php echo e(route('admin.child-developments.edit', $item->id)); ?>" class="btn btn-sm btn-ghost text-base-content/50 hover:text-warning hover:bg-warning/5 rounded-lg font-bold">
                                            ...
                                            <form action="<?php echo e(route('admin.child-developments.destroy', $item->id)); ?>" method="POST" x-data="{ open: false }" @submit.prevent="open = true">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm-delete-modal','data' => ['entityName' => ''.e($item->judul).'','entityType' => 'laporan perkembangan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['entity-name' => ''.e($item->judul).'','entity-type' => 'laporan perkembangan']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
