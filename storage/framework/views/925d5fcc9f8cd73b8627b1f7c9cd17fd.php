            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 max-sm:grid-cols-1">
                <div class="bg-white rounded-xl shadow-sm border border-base-300 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-base-content mt-0.5"><?php echo e($donationCount); ?></div>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-base-300 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                    <div class="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center shrink-0">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-base-content mt-0.5"><?php echo e($sponsorshipCount); ?></div>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-base-300 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-base-content mt-0.5"><?php echo e($donationSuccessCount + $sponsorshipSuccessCount); ?></div>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-base-300 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-base-content mt-0.5"><?php echo e($donationPendingCount + $sponsorshipPendingCount); ?></div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex gap-1 bg-white rounded-xl p-1.5 shadow-sm border border-base-300 items-center justify-between">
                    <div class="flex gap-1">
                        <button @click="tab = 'donasi'"
                            ...
                            Donasi Kampanye
                            <span class="ml-0.5 px-2 py-0.5 rounded-full text-xs font-bold" :class="tab === 'donasi' ? 'bg-white/20' : 'bg-base-300'"><?php echo e($donationCount); ?></span>
                        </button>
                        <button @click="tab = 'sponsor'"
                            ...
                            Orang Tua Asuh
                            <span class="ml-0.5 px-2 py-0.5 rounded-full text-xs font-bold" :class="tab === 'sponsor' ? 'bg-white/20' : 'bg-base-300'"><?php echo e($sponsorshipCount); ?></span>
                        </button>
                    </div>
                    <form action="<?php echo e(route('admin.transactions.sync-all')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                                             ...
                                             <td class="text-center">
                                                <div class="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                                    <?php if($item->status==='pending'): ?>
                                                        <form action="<?php echo e(route('admin.transactions.approve', $item->order_id)); ?>" method="POST" class="inline">
                                                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                                            <button type="submit" class="btn btn-xs bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border-emerald-200 rounded-lg font-bold" title="Konfirmasi manual">
                                                                Konfirmasi
                                                            </button>
                                                        </form>
                                                    <?php endif; ?>
