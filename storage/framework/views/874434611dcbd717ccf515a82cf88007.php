    ...
    <div class="bg-base-200 min-h-screen">
        ...
        <div class="px-8 pt-8 pb-0">
            <div class="flex items-end justify-between gap-3 mb-2 flex-wrap">
                ...
                <a href="<?php echo e(route('admin.campaigns.create')); ?>" class="btn bg-primary hover:bg-primary/90 text-white border-0 font-bold shadow-sm rounded-lg gap-2">
            ...
            <div class="grid grid-cols-3 gap-4 max-sm:grid-cols-1">
                <div class="bg-white rounded-xl shadow-sm border border-base-300 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-base-content mt-0.5"><?php echo e($campaigns->count()); ?></div>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-base-300 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-base-content mt-0.5"><?php echo e($campaigns->where('status', 'active')->count()); ?></div>
                    </div>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-base-300 p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
                                ...
                                <tr class="hover:bg-base-200/30 transition-colors">
                                    <td>
                                        <div class="avatar">
                                            <div class="w-16 h-12 rounded-lg ring ring-base-300 ring-offset-1">
                                                <img src="<?php echo e(asset('storage/' . $campaign->image)); ?>" alt="<?php echo e($campaign->title); ?>" class="object-cover">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="font-bold text-sm text-base-content"><?php echo e($campaign->title); ?></span>
                                        <div class="flex items-center gap-1.5 text-sm font-semibold text-base-content/60 mt-1">
                                            ...
                                            Target: <strong class="text-base-content">Rp <?php echo e(number_format($campaign->target_amount, 0, ',', '.')); ?></strong>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="flex items-center justify-center gap-1">
                                            <a href="<?php echo e(route('admin.campaigns.show', $campaign->id)); ?>" class="btn btn-sm btn-ghost text-base-content/50 hover:text-primary hover:bg-primary/5 rounded-lg font-bold">
                                            ...
                                            <a href="<?php echo e(route('admin.campaigns.edit', $campaign->id)); ?>" class="btn btn-sm btn-ghost text-base-content/50 hover:text-warning hover:bg-warning/5 rounded-lg font-bold">
                                            ...
                                            <form action="<?php echo e(route('admin.campaigns.destroy', $campaign->id)); ?>" method="POST" x-data="{ open: false }" @submit.prevent="open = true">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm-delete-modal','data' => ['entityName' => ''.e($campaign->title).'','entityType' => 'kampanye']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['entity-name' => ''.e($campaign->title).'','entity-type' => 'kampanye']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\donasi-yayasan\resources\views/admin/campaigns/index.blade.php ENDPATH**/ ?>