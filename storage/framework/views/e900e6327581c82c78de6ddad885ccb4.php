    ...
    <div class="bg-gradient-to-b from-emerald-50 to-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div class="rounded-2xl overflow-hidden shadow-lg mb-8 max-h-80">
                <img src="<?php echo e(asset('storage/' . $news->foto_utama)); ?>" alt="<?php echo e($news->judul); ?>" class="w-full h-56 sm:h-72 object-cover">
            </div>
            <?php endif; ?>
            ...
            <div class="flex flex-wrap items-center gap-3 mb-4">
                <?php if($news->kategori): ?>
                    <span class="text-xs font-bold uppercase tracking-wider bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full"><?php echo e($news->kategori); ?></span>
                <?php endif; ?>
                <?php if($news->tanggal_kegiatan): ?>
                    <span class="text-xs text-gray-500">📅 <?php echo e($news->tanggal_kegiatan->format('d M Y')); ?></span>
                <?php endif; ?>
                <?php if($news->lokasi): ?>
                    <span class="text-xs text-gray-500">📍 <?php echo e($news->lokasi); ?></span>
                <?php endif; ?>
            </div>

            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-black text-emerald-800 leading-tight mb-8"><?php echo e($news->judul); ?></h1>
                ...
                <aside class="mt-10 lg:mt-0">
                    <div class="sticky top-24 space-y-6">
                            ...
                            <div class="p-5 space-y-4">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-emerald-700"><?php echo e($news->tanggal_kegiatan->format('d F Y')); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                <?php if($news->lokasi): ?>
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-emerald-700"><?php echo e($news->lokasi); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-emerald-700"><?php echo e($news->penyelenggara); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                <?php if($news->kategori): ?>
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-emerald-700"><?php echo e($news->kategori); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-xl p-6 text-white shadow-md">
                            ...
                            <a href="<?php echo e(url('/#kampanye')); ?>" class="inline-block bg-white text-emerald-700 text-xs font-bold px-5 py-2.5 rounded-lg hover:bg-emerald-50 transition-colors shadow-sm">
                                Donasi Sekarang →
                            </a>
                        </div>
                    </div>
