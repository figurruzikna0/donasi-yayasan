...
<?php endif; ?>
            ...
            <div class="relative z-10">
                <a href="/" class="flex flex-col items-center gap-3">
                    <?php $logoProfil = $profil; ?>
                    <?php if($logoProfil?->logo): ?>
                        <div class="p-2.5 bg-white/95 rounded-2xl shadow-lg ring-1 ring-white/20 backdrop-blur-sm">
                            <img src="<?php echo e(asset('storage/' . $logoProfil->logo) . '?v=' . now()->timestamp); ?>" class="h-14 w-14 rounded-xl object-cover" alt="Logo">
                        </div>
                    <?php else: ?>
                        <span class="text-4xl bg-white/95 p-3 rounded-2xl shadow-lg ring-1 ring-white/20">🌿</span>
                    <?php endif; ?>
                    <span class="text-sm font-bold text-white/90 tracking-wide"><?php echo e($logoProfil?->nama_yayasan ?? 'Yayasan Baitul Yatim'); ?></span>
                </a>
            </div>
            ...
            <p class="relative z-10 mt-6 text-xs text-white/40 font-semibold tracking-wider">© <?php echo e(date('Y')); ?> <?php echo e($logoProfil?->nama_yayasan ?? 'Yayasan Baitul Yatim'); ?>. All rights reserved.</p>
        </div>
    </body>
</html>
<?php /**PATH C:\laragon\www\donasi-yayasan\resources\views/layouts/guest.blade.php ENDPATH**/ ?>