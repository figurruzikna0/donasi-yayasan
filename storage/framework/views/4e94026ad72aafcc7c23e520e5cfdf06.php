        ...
        <div class="flex-none hidden sm:flex">
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow-lg">
                    <li><a :href="route('profile.edit')" onclick="event.preventDefault(); window.location.href='<?php echo e(route('profile.edit')); ?>'">Profile</a></li>
                    <li>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\donasi-yayasan\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>