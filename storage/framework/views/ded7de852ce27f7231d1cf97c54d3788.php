        ...
        <div class="bg-gradient-to-br from-primary via-primary to-primary/90 text-white relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <a href="<?php echo e(Auth::user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')); ?>" class="btn btn-sm bg-white/20 hover:bg-white/30 text-white border-0 backdrop-blur-sm rounded-lg font-bold flex items-center gap-1.5">
                            ...
                            <div class="flex-shrink-0 text-center w-full sm:w-auto">
                                <div class="avatar">
                                    <div class="w-24 h-24 rounded-full ring ring-base-300 ring-offset-2 ring-offset-white mx-auto">
                                        <?php if($user->avatar): ?>
                                            <img src="<?php echo e(asset('storage/' . $user->avatar) . '?v=' . now()->timestamp); ?>" id="preview-avatar" alt="Avatar" class="object-cover">
                                        <?php else: ?>
                                            <div id="preview-avatar" class="w-full h-full bg-primary/10 text-primary font-black text-3xl flex items-center justify-center uppercase"><?php echo e(substr($user->name, 0, 1)); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex-1 space-y-4 w-full">
                                <div>
                                    ...
                                    <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" class="input input-bordered w-full border-base-300 focus:border-primary rounded-lg text-sm" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="input input-bordered w-full border-base-300 focus:border-primary rounded-lg text-sm" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" class="input input-bordered w-full border-base-300 focus:border-primary rounded-lg text-sm" placeholder="08xxxx">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="nik" value="<?php echo e(old('nik', $user->nik)); ?>" class="input input-bordered w-full border-base-300 focus:border-primary rounded-lg text-sm" placeholder="Nomor Induk Kependudukan">
                                        <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="address" rows="3" class="textarea textarea-bordered w-full border-base-300 focus:border-primary rounded-lg text-sm" placeholder="Alamat lengkap"><?php echo e(old('address', $user->address)); ?></textarea>
    ...
    <script>
        ...
        document.getElementById('btn-hapus-foto')?.addEventListener('click', function() {
            ...
            if (existing.tagName === 'IMG') {
                ...
                div.textContent = '<?php echo e(substr($user->name, 0, 1)); ?>';
