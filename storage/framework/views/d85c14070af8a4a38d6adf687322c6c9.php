                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        <?php $__empty_1 = true; $__currentLoopData = $pendiris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendiri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-start gap-3 p-4 border border-emerald-200 rounded-xl bg-emerald-50 hover:border-emerald-300 hover:bg-white transition-all">
                                <?php if($pendiri->foto): ?>
                                    <img src="<?php echo e(asset('storage/' . $pendiri->foto)); ?>" class="w-12 h-12 rounded-xl object-cover border-2 border-emerald-300 flex-shrink-0" alt="<?php echo e($pendiri->nama); ?>">
                                <?php else: ?>
                                    <div class="w-12 h-12 rounded-xl bg-emerald-200 text-emerald-700 font-bold flex items-center justify-center flex-shrink-0"><?php echo e(strtoupper(substr($pendiri->nama, 0, 1))); ?></div>
                                <?php endif; ?>
                                <div class="flex-1 min-w-0">
                                    <p class="font-bold text-emerald-700 text-sm"><?php echo e($pendiri->nama); ?></p>
                                    <p class="text-xs font-semibold text-emerald-500"><?php echo e($pendiri->jabatan); ?></p>
                                    <?php if($pendiri->deskripsi): ?>
                                        <p class="text-xs text-emerald-400 italic mt-1 line-clamp-2">"<?php echo e($pendiri->deskripsi); ?>"</p>
                                    <?php endif; ?>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-control">
                                ...
                                <input type="text" name="nama" class="input input-bordered w-full" required value="<?php echo e(old('nama')); ?>" placeholder="Nama lengkap">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="jabatan" class="input input-bordered w-full" required value="<?php echo e(old('jabatan')); ?>" placeholder="Ketua Yayasan">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-control mt-4">
                            ...
                            <textarea name="deskripsi" rows="3" class="textarea textarea-bordered w-full" placeholder="Kata sambutan singkat…"><?php echo e(old('deskripsi')); ?></textarea>
