            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl sm:text-2xl font-bold text-white">Edit Profil</h1>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-4 space-y-5 pb-8">
            ...
            <div class="bg-white rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.04)] border border-slate-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
                    <div class="w-9 h-9 rounded-lg bg-emerald-100 flex items-center justify-center text-base shrink-0">
                                <svg class="w-5 h-5 text-emerald-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                            </div>
                    <div>
                        <p class="font-extrabold text-sm text-slate-800">Data Diri</p>
                        <p class="text-xs text-slate-400">Informasi profil akun Anda</p>
                    </div>
                </div>
                <div class="p-6">
                            ...
                            <div class="flex-shrink-0 text-center w-full sm:w-auto">
                                <div class="avatar">
                                    <div class="w-24 h-24 rounded-full ring ring-emerald-100 ring-offset-2 ring-offset-white mx-auto">
                                        ...
                                        @else
                                            <div id="preview-avatar" class="w-full h-full bg-emerald-100 text-emerald-700 font-black text-3xl flex items-center justify-center uppercase">{{ substr($user->name, 0, 1) }}</div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="flex-1 space-y-4 w-full">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="nik" value="{{ old('nik', $user->nik) }}" class="input input-bordered w-full border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-lg text-sm" placeholder="Nomor Induk Kependudukan">
            ...
            <div class="bg-white rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.04)] border border-slate-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-extrabold text-sm text-slate-800">Ubah Password</p>
                    ...
                    <form method="post" action="{{ route('password.update') }}" class="space-y-4 max-w-lg">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex w-full">
                                    <input type="password" name="password" id="new_password" class="input input-bordered w-full border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-l-lg text-sm" required>
                                    <button type="button" class="btn btn-outline border-slate-300 border-l-0 rounded-r-lg toggle-pw" data-target="new_password">
                                        <svg class="w-4 h-4 text-slate-400 toggle-eye" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                    </button>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="flex w-full">
                                    <input type="password" name="password_confirmation" id="password_confirmation" class="input input-bordered w-full border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-l-lg text-sm" required>
                                    <button type="button" class="btn btn-outline border-slate-300 border-l-0 rounded-r-lg toggle-pw" data-target="password_confirmation">
                                        <svg class="w-4 h-4 text-slate-400 toggle-eye" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                    </button>
                                </div>
                            </div>
    ...
    <script>
        ...
        document.getElementById('btn-hapus-foto')?.addEventListener('click', function() {
            ...
            if (existing.tagName === 'IMG') {
                ...
                div.className = 'w-full h-full bg-emerald-100 text-emerald-700 font-black text-3xl flex items-center justify-center uppercase';
