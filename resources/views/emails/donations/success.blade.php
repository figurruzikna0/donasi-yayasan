...
<p style="margin:0 0 6px;color:#374151;font-size:15px;">Assalamu'alaikum, <strong>{{ $donation->donor_name }}</strong></p>
...
<tr><td style="border-bottom:1px solid #e5e7eb;color:#6b7280;font-size:13px;width:110px;">Program</td><td style="border-bottom:1px solid #e5e7eb;color:#111827;font-size:14px;font-weight:600;">{{ $donation->campaign?->title ?? 'Program Donasi' }}</td></tr>
<tr><td style="border-bottom:1px solid #e5e7eb;color:#6b7280;font-size:13px;">Nominal</td><td style="border-bottom:1px solid #e5e7eb;color:#059669;font-size:16px;font-weight:700;">Rp {{ number_format($donation->amount, 0, ',', '.') }}</td></tr>
<tr><td style="border-bottom:1px solid #e5e7eb;color:#6b7280;font-size:13px;">Metode</td><td style="border-bottom:1px solid #e5e7eb;color:#111827;font-size:14px;">{{ $donation->payment_method ?? '-' }}</td></tr>
<tr><td style="color:#6b7280;font-size:13px;">ID Transaksi</td><td style="color:#111827;font-size:13px;font-family:monospace;">{{ $donation->order_id }}</td></tr>
</table>
