<x-app-layout>
    <style>
        ...
        .donor-email { font-size: 0.72rem; color: var(--muted-olive); margin: 1px 0; }
        .donor-phone { font-size: 0.72rem; color: var(--muted-olive); display: flex; align-items: center; gap: 3px; }

        .child-tag { display: inline-block; padding: 2px 8px; background: #edf7e2; border: 1px solid var(--celadon); border-radius: 6px; font-size: 0.68rem; font-weight: 700; color: var(--sage-green); margin-top: 4px; }
        .package-tag { display: inline-block; padding: 2px 8px; background: #fdf6e3; border: 1px solid #e8d8a0; border-radius: 6px; font-size: 0.68rem; font-weight: 700; color: #92651a; margin-top: 4px; margin-left: 4px; }

        .amount-value { font-size: 0.9rem; font-weight: 900; color: var(--fern); }
        .order-id { font-size: 0.68rem; font-family: 'JetBrains Mono', monospace; color: var(--muted-olive); margin-top: 3px; }
        .payment-method-note { font-size: 0.68rem; color: var(--muted-olive); margin-top: 1px; }

        .period-main { font-size: 0.78rem; font-weight: 700; color: var(--fern); }
        .period-sub { font-size: 0.7rem; color: var(--muted-olive); margin-top: 2px; }
        ...
        .badge-aktif { background: rgba(34, 197, 94, 0.1); color: #16a34a; border: 1px solid rgba(34,197,94,0.25); }
        ...
        .badge-kadaluarsa { background: rgba(148, 163, 184, 0.12); color: #64748b; border: 1px solid rgba(148,163,184,0.3); }
        .badge-kadaluarsa .badge-dot { background: #94a3b8; }
        ...
        .delete-btn svg, .approve-btn svg { width: 16px; height: 16px; }
    ...
    <div class="shell">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                {{-- AKTIF --}}
                <a href="{{ route('admin.sponsorships.index') }}" class="nav-item active">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    Orang Tua Asuh
                    <span class="nav-badge">{{ $sponsorships->where('status', 'pending')->count() }}</span>
                </a>
            </nav>
            ...
            <main class="content-area">
                ...
                <div class="page-header">
                    <div>
                        ...
                        <h1 class="page-title">Sponsorship Orang Tua Asuh</h1>
                        <p class="page-subtitle">Pantau status sponsorship anak asuh, masa aktif, dan jatuh tempo perpanjangan.</p>
                    </div>
                </div>
                ...
                <div class="table-card">
                    ...
                    <div class="toolbar">
                        <div class="search-table-wrap">
                            ...
                            <input type="text" id="tableSearch" class="table-search-input"
                                   placeholder="Cari nama, anak asuh, order ID…">
                        </div>
                                ...
                                @forelse($sponsorships as $sponsorship)
                                    ...
                                    <tr class="data-row"
                                        ...
                                        <td>
                                            <div class="donor-cell">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="donor-email">{{ $sponsorship->donor_email }}</div>
                                                    <div class="donor-phone">📱 {{ $sponsorship->donor_phone ?? '-' }}</div>
                                                    <span class="child-tag">{{ $sponsorship->fosterChild->name ?? 'Anak Dihapus' }}</span>
                                                </div>
                                            </div>
                                        </td>

                                        <td>
                                            <span class="package-tag" style="margin-left:0;">{{ $sponsorship->package ?? '-' }}</span>
                                            <div class="amount-value" style="margin-top:6px;">Rp {{ number_format($sponsorship->amount, 0, ',', '.') }}</div>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <div class="period-main">-</div>
                                                <div class="period-sub">Belum dibayar</div>
                                            @endif
                                        </td>
                                        ...
                                        <td style="text-align:center;">
                                            ...
                                            @else
                                                <span class="badge badge-gagal"><span class="badge-dot"></span> Gagal</span>
                                            @endif
                                        </td>
                                    ...
                                    <tr id="emptyInitRow">
                                        <td colspan="5">
                                            <div class="empty-state">
                                                ...
                                                <p class="empty-title">Belum Ada Sponsorship</p>
                                                <p class="empty-sub">Sponsorship anak asuh yang masuk lewat Midtrans akan tampil di sini.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                    ...
                    <div class="table-footer">
                        <div class="pagination-info" id="paginationInfo">Menampilkan <strong>0</strong> hasil</div>
