            ...
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                <div class="card-body flex-row items-center gap-3 p-5">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-emerald-700">{{ $campaigns->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                <div class="card-body flex-row items-center gap-3 p-5">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-emerald-700">{{ $campaigns->where('status', 'active')->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                    ...
                    <tbody>
                        @forelse($campaigns as $campaign)
                            <tr>
                                ...
                                <td>
                                    <div class="font-extrabold text-emerald-700 text-sm mb-1">{{ $campaign->title }}</div>
                                    <div class="inline-flex items-center gap-1.5 text-sm font-semibold text-emerald-500">
                                        ...
                                        Target: <strong class="text-emerald-700 font-extrabold">Rp {{ number_format($campaign->target_amount, 0, ',', '.') }}</strong>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('admin.campaigns.destroy', $campaign->id) }}" method="POST"
                                            ...
                                            <dialog class="modal" :class="{ 'modal-open': open }">
                                                <div class="modal-box"><h3 class="font-bold text-lg">Konfirmasi Hapus</h3><p class="py-4">Yakin ingin menghapus kampanye <strong>{{ $campaign->title }}</strong>?</p>
