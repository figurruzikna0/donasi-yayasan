    ...
    <div class="bg-base-200 min-h-screen">
        ...
        <div class="px-8 pt-8 pb-0">
            <div class="flex items-end justify-between gap-3 mb-2 flex-wrap">
                ...
                <a href="{{ route('admin.foster-children.create') }}" class="btn bg-primary hover:bg-primary/90 text-white border-0 font-bold shadow-sm rounded-lg gap-2">
                        ...
                        <tbody>
                            @forelse($children as $child)
                                <tr class="hover:bg-base-200/30 transition-colors">
                                    ...
                                    <td>
                                        <span class="font-bold text-sm text-base-content">{{ $child->name }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="flex items-center justify-center gap-1">
                                            <a href="{{ route('admin.foster-children.show', $child->id) }}" class="btn btn-sm btn-ghost text-base-content/50 hover:text-primary hover:bg-primary/5 rounded-lg font-bold">
                                            ...
                                            <a href="{{ route('admin.foster-children.edit', $child->id) }}" class="btn btn-sm btn-ghost text-base-content/50 hover:text-warning hover:bg-warning/5 rounded-lg font-bold">
