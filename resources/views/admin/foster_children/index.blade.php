<x-app-layout>
    ...
    <div class="bg-base-200 p-8">
        ...
        <div class="flex items-end justify-between gap-3 mb-7 flex-wrap">
            ...
            <a href="{{ route('admin.foster-children.create') }}" class="btn btn-success">
            ...
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                <div class="card-body flex-row items-center gap-3 p-5">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-emerald-700">{{ $children->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                <div class="card-body flex-row items-center gap-3 p-5">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-emerald-700">{{ $children->where('jenis_kelamin', 'Laki-laki')->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                <div class="card-body flex-row items-center gap-3 p-5">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-emerald-700">{{ $children->where('jenis_kelamin', 'Perempuan')->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="card bg-base-100 shadow-md border border-emerald-200">
                <div class="card-body flex-row items-center gap-3 p-5">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-emerald-700">{{ $children->where('status', '!=', 'Tersedia')->count() }}</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse($children as $child)
                            <tr>
                                ...
                                <td>
                                    <span class="font-extrabold text-emerald-700 text-sm">{{ $child->name }}</span>
                                </td>
