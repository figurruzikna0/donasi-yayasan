<!-- ============================================ -->
<!-- admin\foster_children\index.blade.php        -->
<!-- Halaman daftar anak asuh (CRUD)              -->
<!-- Dipakai oleh Admin\FosterChildController@index -->
<!-- Alur: menampilkan kartu statistik (total,    -->
<!-- gender, sedang diasuh), lalu tabel anak      -->
<!-- dengan kolom Foto, Nama, Umur, JK, Status,   -->
<!-- Aksi; paginasi via $children->links()        -->
<!-- ============================================ -->
<x-admin-layout>
<div class="bg-gradient-to-b from-base-200 to-base-300 min-h-0">

    <!-- Header halaman: judul dan tombol tambah anak asuh -->
    <div class="relative overflow-hidden bg-gradient-to-r from-emerald-800 via-emerald-600 to-teal-500">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="flex items-center justify-between flex-wrap gap-4">
                ...
                <!-- Tombol menuju halaman create anak asuh -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 pb-12 space-y-6">
        ...
        <!-- ============================================ -->
        <!-- Kartu statistik anak asuh (4 kartu):         -->
        <!-- 1. Total anak asuh ($allChildren)            -->
        <!-- 2. Jumlah laki-laki                          -->
        <!-- 3. Jumlah perempuan                          -->
        <!-- 4. Sedang diasuh (status != 'Tersedia')      -->
        <!-- ============================================ -->
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 max-sm:grid-cols-1">
            <!-- Kartu total seluruh anak asuh -->
            ...
            <!-- Kartu jumlah anak laki-laki (filter jenis_kelamin = 'Laki-laki') -->
            <div class="relative bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-base-200 p-6 overflow-hidden group hover:-translate-y-0.5 transition-all duration-300">
            ...
            <!-- Kartu jumlah anak perempuan (filter jenis_kelamin = 'Perempuan') -->
            <div class="relative bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-base-200 p-6 overflow-hidden group hover:-translate-y-0.5 transition-all duration-300">
            ...
            <!-- Kartu jumlah anak dengan status sedang diasuh -->
            <div class="relative bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-base-200 p-6 overflow-hidden group hover:-translate-y-0.5 transition-all duration-300">
            ...
            <div class="overflow-x-auto">
                <table class="table w-full">
                    ...
                    <tbody class="divide-y divide-base-100">
                        <!-- forelse: tampilkan tiap baris anak, atau pesan kosong -->
                        @forelse($children as $child)
                            <tr class="hover:bg-emerald-50/40 transition-colors duration-150 group">
                                <td class="py-4 px-6">
                                    <!-- Jika anak punya foto, tampilkan; jika tidak, ikon placeholder -->
                                    @if($child->photo)
                                        <div class="avatar">
                                ...
                                <td class="py-4 px-6">
                                    <!-- Umur anak (disimpan sebagai string, mis. "4 tahun") -->
                                ...
                                <td class="py-4 px-6">
                                    <!-- Badge jenis kelamin: biru untuk laki-laki, pink untuk perempuan -->
                                ...
                                <td class="py-4 px-6">
                                    <!-- Blok php: menentukan ikon & warna badge berdasarkan status -->
                                    <!-- 'Tersedia' (hijau) atau 'Diasuh' (biru/primary) -->
                                    @php
                                ...
                                <td class="py-4 px-6 text-center">
                                    ...
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <!-- Form hapus anak: method DELETE; submit dicegah lalu -->
                                        ...
                                        <form action="{{ route('admin.foster-children.destroy', $child->id) }}" method="POST" x-data="{ open: false }" @submit.prevent="open = true">
                                            ...
                                            <!-- Modal konfirmasi hapus anak asuh (komponen reusable) -->
                        ...
                        @empty
                            <!-- Kondisi daftar kosong: tampilkan pesan "Belum ada data anak asuh" -->
                            <tr>
                                <td colspan="6">
