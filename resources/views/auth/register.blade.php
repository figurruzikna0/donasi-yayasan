    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-control">
            ...
            <input id="name" type="text" name="name" placeholder="Budi Santoso"
                   class="input input-bordered w-full border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-lg px-4 py-3 text-sm transition-all bg-white"
        ...
        <div class="form-control mt-4">
            ...
            <textarea id="address" name="address" rows="2" placeholder="Alamat lengkap..."
                      class="textarea textarea-bordered w-full border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-lg px-4 py-3 text-sm transition-all bg-white min-h-[80px]">{{ old('address') }}</textarea>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
            <div class="form-control">
                ...
                <div class="flex w-full">
                    <input id="password" type="password" name="password" placeholder="Min 8 karakter"
                           class="input input-bordered w-full border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-l-lg px-4 py-3 text-sm transition-all bg-white"
            ...
            <div class="form-control">
                ...
                <div class="flex w-full">
                    <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Ulangi"
                           class="input input-bordered w-full border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-l-lg px-4 py-3 text-sm transition-all bg-white"
                           required autocomplete="new-password" />
                    <button type="button" onclick="togglePassword('password_confirmation', 'eyeIconConfirm')" class="btn border-slate-300 border-l-0 rounded-r-lg bg-white hover:bg-slate-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" id="eyeIconConfirm">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                        </svg>
                    </button>
