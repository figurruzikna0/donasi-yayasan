<!-- ============================================ -->
<!-- donations\campaign_detail.blade.php — detail program donasi -->
<!-- ============================================ -->
<!-- Peran     : halaman informasi lengkap sebuah kampanye donasi (foto, target, terkumpul, deskripsi). -->
<!-- Controller: CampaignController (route publik) — variabel $campaign (Campaign). -->
<!-- Alur      : dari halaman utama klik program donasi -> detail tampil -> tekan "Donasi Sekarang" -->
<!--             (wajib login) menuju form donasi (donations\create.blade.php). -->
<x-app-layout>
    <div class="bg-base-200 min-h-0">

        <!-- BANNER ATAS: judul halaman dan tombol kembali ke beranda -->
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <!-- FOTO PROGRAM: tap/klik foto untuk membukanya di tab baru (perbesar) -->
                @if($campaign->image)
                    <div class="bg-slate-50 p-4 sm:p-6 border-b border-slate-100 flex justify-center">
                        <!-- onclick JS: membuka gambar asli campaign (storage) di tab baru -->
                        <div class="relative group cursor-pointer" onclick="window.open('{{ asset('storage/' . $campaign->image) }}', '_blank')">
                            ...
                            <!-- OVERLAY "KLIK PERBESAR": muncul saat kursor di atas foto -->
                ...
                <div class="p-6 sm:p-8 lg:p-10">
                    ...
                    <div class="flex items-start justify-between flex-wrap gap-4 mb-6">
                        <div>
                            <!-- BADGE KATEGORI: menandai jenis konten sebagai "Program Donasi" -->
                    ...
                    <!-- PROGRES DANA: jumlah terkumpul vs target + progress bar -->
                    <div class="bg-emerald-50 rounded-xl p-5 sm:p-6 mb-8">
                        ...
                        <!-- PROGRESS BAR: lebar bar = persentase dana terkumpul (dibatasi maksimal 100%) -->
                        ...
                        <!-- TEKS PERSENTASE: menampilkan berapa persen target yang tercapai -->
                    ...
                    <!-- DESKRIPSI PROGRAM: penjelasan lengkap kampanye (bila diisi) -->
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-slate-200">
                        <!-- KONDISI: pengguna SUDAH login -> tombol langsung ke form donasi; -->
                        <!-- BELUM login -> tombol diarahkan ke halaman login terlebih dahulu -->
                        @auth
