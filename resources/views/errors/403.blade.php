<!-- ============================================ -->
<!-- errors/403.blade.php - HALAMAN ERROR 403 (AKSES DITOLAK) -->
<!-- ============================================ -->
<!-- Peran: halaman kesalahan yang tampil otomatis oleh Laravel ketika pengguna tidak memiliki izin mengakses halaman (status HTTP 403). -->
<!-- Data: $profil (nama yayasan) dari view composer global, dipakai untuk judul halaman dan teks copyright. -->
<!-- Alur: menampilkan layar penuh berlatarkan gradasi hijau dengan angka 403 besar, ikon gembok, pesan penjelasan, tombol Kembali ke Beranda dan Login, lalu copyright. -->
<!DOCTYPE html>
...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 px-4">
        ...
        <div class="relative z-10 text-center max-w-md">
            <!-- Angka kode error 403 besar sebagai fokus visual -->
            <div class="mb-8">
                <span class="text-8xl font-black text-emerald-300/30 select-none">403</span>
            </div>

            <!-- Ikon gembok tertutup sebagai penanda akses terlarang -->
            ...
            <!-- Tombol aksi: kembali ke beranda dan menuju halaman login -->
