    ...
    <div class="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 px-4">
        ...
        <div class="relative z-10 text-center max-w-md">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a href="{{ route('profil') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold text-emerald-200 border border-emerald-700/50 hover:bg-emerald-800/30 transition-all duration-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"/></svg>
                    Hubungi Kami
                </a>
            </div>
        </div>
